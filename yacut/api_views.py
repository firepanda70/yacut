...
from . import app, db
from .contants import HOST, URL_REGEXP
from .error_handlers import InvalidAPIUsage
from .models import URL_map
from .views import get_unique_short_id, is_shortcut_exists, is_shortcut_valid
...
def add_url_map():
    ...
    if 'custom_id' in data and data['custom_id'] not in ('', None):
        if not is_shortcut_valid(data['custom_id']):
